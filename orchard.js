...
const all = fujiAcres.concat(galaAcres, pinkAcres)
...
let averageDailyAcres = totalAcres / all.length
...
let fujiTons = fujiAcres.slice(8, fujiAcres.length)
let galaTons = galaAcres.slice(8, galaAcres.length)
let pinkTons = pinkAcres.slice(8, pinkAcres.length)
